...
export default function LatestNewsCard({
  ...
  const fallbackSrc = '/news-placeholder.jpg';
  ...
  if (variant === 'featured') {
    return (
      <Wrapper>
        <div className="bg-white h-full flex flex-col rounded-2xl shadow-lg overflow-hidden hover:shadow-xl transition-shadow duration-300">
  ...
  return (
    <Wrapper>
      <div className="bg-white h-full flex rounded-2xl shadow-lg p-3 sm:p-4 gap-3 sm:gap-4 hover:shadow-xl transition-shadow duration-300">
