                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
                    ...
                    <div className="relative bg-gray-50 rounded-2xl px-8 py-12 text-center shadow-sm">
                        ...
                        <p className="mt-4 text-sm text-gray-600 leading-relaxed">
                            Users can view the newsfeed, create posts, like,
                            comment, and share updates with others.
                        </p>
                    </div>
                    ...
                    <div className="relative bg-gray-50 rounded-2xl px-8 py-12 text-center shadow-sm">
                        ...
                        <p className="mt-4 text-sm text-gray-600 leading-relaxed">
                            Users can see flooded areas based on a selected
                            location using an interactive map.
                        </p>
                    </div>
                    ...
                    <div className="relative bg-gray-50 rounded-2xl px-8 py-12 text-center shadow-sm">
                        ...
                        <p className="mt-4 text-sm text-gray-600 leading-relaxed">
                            Users can read safety tips and prevention guides
                            that help protect lives during disasters.
                        </p>
                    </div>
