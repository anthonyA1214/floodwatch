    ...
    <BoundaryProvider>
      <MapProvider>
        <div className="relative w-full h-full">
          ...
          <div className="absolute top-0 left-0 right-0 z-10 flex items-start gap-4 pointer-events-none h-full">
            ...
            <div className="pointer-events-none flex-1 min-w-0 flex items-start h-full">
              ...
              <div className="flex-1 min-w-0 sm:flex-none max-w-sm ps-4 pt-4">
