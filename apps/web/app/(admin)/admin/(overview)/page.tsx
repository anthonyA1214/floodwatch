...
export default function Dashboard() {
  return (
    ...
    <section className="flex-1 bg-white p-8 rounded-2xl">
      <h1 className="text-4xl font-bold text-black">Hello, John Doe</h1>
      ...
      <div className="mt-4 rounded-xl border border-gray-300 bg-white p-6">
        <h1 className="mb-4 text-xl">Active Flood Alerts</h1>
      ...
      {/* Safety Location */}
      <div className="mt-4 rounded-xl border border-gray-300 bg-white p-6">
        <h1 className="mb-4 text-xl">Safety Location</h1>
